        ...
        <div className="card-block">
          <form>
            <div className="form-group row">
              <label className="lead col-sm-2 col-form-label">Writing</label>
            ...
            <div className="form-group row">
              <label className="lead col-sm-2 col-form-label">Reading</label>
              <div className="col-sm-10">
            ...
            <div className="form-group row">
              <label className="lead col-sm-2 col-form-label">Translation</label>
              <div className="col-sm-10">
